...
ADD COLUMN job_title VARCHAR(100) DEFAULT NULL AFTER phone,
ADD COLUMN company VARCHAR(150) DEFAULT NULL AFTER job_title,
ADD COLUMN website VARCHAR(255) DEFAULT NULL AFTER company,
ADD COLUMN github VARCHAR(255) DEFAULT NULL AFTER website,
ADD COLUMN linkedin VARCHAR(255) DEFAULT NULL AFTER github,
ADD COLUMN twitter VARCHAR(255) DEFAULT NULL AFTER linkedin;
